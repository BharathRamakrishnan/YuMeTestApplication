//
//  YuMeSdkUnitTestSetAutoPrefetch.m
//  YuMeiOSTestApp
//
...
#import "YuMeSdkUnitTestSetAutoPrefetch.h"
#import "YuMeSdkUnitUtils.h"

@implementation YuMeSdkUnitTestSetAutoPrefetch
...
/* Expected behavior */
// 1. Throws Exception: "YuMeSDK_SetAutoPrefetch(): YuMe SDK is not Initialized."
- (void)testCase_SetAutoPrefetch001 {
    ...
    GHAssertFalse([yumeSDK yumeSdkSetAutoPrefetch:TRUE errorInfo:&pError], @"Initialization is not Successful.");
    if (pError) {
        NSString *str = [YuMeSdkUnitUtils getErrDesc:pError];
        GHAssertEqualObjects(str, @"yumeSdkSetAutoPrefetch(): YuMe SDK is not Initialized.", @"");
        ...
        NSString *str = @"Throws Exception Failed: yumeSdkSetAutoPrefetch(): YuMe SDK is not Initialized.";
        [testCaseResult setObject:str forKey:@"status"];
...
/* Expected behavior */
// 1. Sets the new value for auto prefetch flag in YuMeAdParams object in the SDK.
- (void)testCase_SetAutoPrefetch002 {
    ...
    BOOL bAutoPrefetch = !adParams.bEnableAutoPrefetch;
    
    GHAssertTrue([yumeSDK yumeSdkSetAutoPrefetch:bAutoPrefetch errorInfo:&pError], @"yumeSdkSetAutoPrefetch Successful.");
    GHTestLog(@"yumeSdkSetAutoPrefetch called.");
    ...
    if (pError) {
        ...
        NSString *str = @"yumeSdkSetAutoPrefetch Successful.";
        [testCaseResult setObject:str forKey:@"status"];
        [testCaseResult setObject:@"Pass" forKey:@"result"];
        [resultArray addObject:testCaseResult];
        adParams = [yumeSDK yumeSdkGetAdParams:&pError];
        GHAssertEquals(bAutoPrefetch, params.bEnableAutoPrefetch, @"auto prefetch flag in YuMeAdParams object in the SDK.");
    }
    
#if kTEST_REPORT
    [YuMeSdkUnitUtils createTestReport:resultArray title:@"Set AutoPrefetch"];
#endif
